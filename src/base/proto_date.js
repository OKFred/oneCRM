...
Date.prototype.isPDT = function () {
    ...
    let today = this.valueOf();
    let thisWeekday = this.getDay();
    let lastSunday = thisWeekday === 0 ? today : today - thisWeekday * 86400000;
    let aWeekBeforeLastSunday = lastSunday - 7 * 86400000;
    let monthOfLastSunday = new Date(lastSunday).getMonth() + 1;
    let monthOfaWeekBeforeLastSunday = new Date(aWeekBeforeLastSunday).getMonth() + 1;
